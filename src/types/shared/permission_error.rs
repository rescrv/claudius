...
mod tests {
    ...
    fn test_permission_error_serialization() {
        ...
        assert_eq!(json, r#"{"message":"You don't have permission to access this resource","type":"permission_error"}"#);
    }
    ...
    fn test_permission_error_deserialization() {
        ...
        assert_eq!(error.message, "You don't have permission to access this resource");
